...
const m: Record<string, {speciality: string, Icon: (props: React.SVGProps<SVGSVGElement>) => React.JSX.Element}> = {
  cardiology: {
...
export const formatDate = (dateString: string | null, locale: string = 'es-ES'): string | null => { // TODO: change locale depending on the browser's locale
